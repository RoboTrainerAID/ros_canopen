 ...
 * Example
	...
	print current state
	Channel Index: 0 brightness: 0
	Channel Index: 1 brightness: 20
	Channel Index: 2 brightness: 0
	Channel Index: 3 brightness: 0
	Channel Index: 4 brightness: 0
	Channel Index: 5 brightness: 0
	Channel Index: 6 brightness: 0
	Channel Index: 7 brightness: 0
	Channel Index: 8 brightness: 0
	Channel Index: 9 brightness: 0
...
public:
	...
	std::map<int, int> compare(std::vector<int> led_channel_set) {
		...
		auto leftIt = this->led_channels.begin();
		auto rightIt = led_channel_set.begin();
	...
	std::map<int, int> compare(int bank, std::vector<int> bank_set) {
		...
		auto leftIt = bank_channels.begin();
		auto rightIt = bank_set.begin();
